...
def initiate():
    ...
    car_model_data = [
        ...
        {"name":"C-Class", "type":"SUV", "year":2023, "dealer_id":5, "car_make":car_make_instances[1]},
        {"name":"E-Class", "type":"SUV", "year":2023, "dealer_id":6, "car_make":car_make_instances[1]},
        {"name":"A4", "type":"SUV", "year":2023, "dealer_id":7, "car_make":car_make_instances[2]},
        {"name":"A5", "type":"SUV", "year":2023, "dealer_id":8, "car_make":car_make_instances[2]},
        {"name":"A6", "type":"SUV", "year":2023, "dealer_id":9, "car_make":car_make_instances[2]},
